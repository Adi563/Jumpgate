...
{
    public class SpecialParagraph : CharacterBase
    {
        public SpecialParagraph()
        {
            ...
            BooleanMap[6] = new bool[] { false, false, true, false, true, false };
            BooleanMap[7] = new bool[] { false, false, false, true, true, false };
            BooleanMap[8] = new bool[] { false, true, false, false, true, false };
            BooleanMap[9] = new bool[] { false, true, true, true, true, false };
