...
{
    public class NumberSeven : CharacterBase
    {
        public NumberSeven()
        {
            ...
            BooleanMap[3] = new bool[] { false, false, false, false, false, true };
            BooleanMap[4] = new bool[] { false, false, false, false, false, true };
            BooleanMap[5] = new bool[] { false, false, false, true, true, false };
        ...
        public override char Character { get { return '7'; } }
    }
}