...
{
    public class LowerEWithAcute : CharacterBase
    {
        public LowerEWithAcute()
        {
            BooleanMap = new bool[11][];

            BooleanMap[0] = new bool[] { false, false, false, true, false, false };
            BooleanMap[1] = new bool[] { false, false, true, false, false, false };
        ...
        public override char Character { get { return 'é'; } }
    }
}