...
{
    public class SpecialBrokenBar : CharacterBase
    {
        public SpecialBrokenBar()
        {
            ...
            BooleanMap[4] = new bool[] { false, false, false, false, false, false };
            BooleanMap[5] = new bool[] { false, false, false, false, false, false };
