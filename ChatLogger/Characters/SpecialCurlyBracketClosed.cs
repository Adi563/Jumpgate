...
{
    public class SpecialCurlyBracketClosed : CharacterBase
    {
        public SpecialCurlyBracketClosed()
        {
            BooleanMap = new bool[11][];

            BooleanMap[0] = new bool[6];
            BooleanMap[1] = new bool[6];
            BooleanMap[2] = new bool[] { false, true, true, false, false, false };
            BooleanMap[3] = new bool[] { false, false, false, true, false, false };
            BooleanMap[4] = new bool[] { false, false, false, false, true, true };
            BooleanMap[5] = new bool[] { false, false, false, true, false, false };
            BooleanMap[6] = new bool[] { false, false, false, true, false, false };
            BooleanMap[7] = new bool[] { false, true, true, false, false, false };
