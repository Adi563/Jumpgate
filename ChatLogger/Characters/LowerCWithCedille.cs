...
{
    public class LowerCWithCedille : CharacterBase
    {
        public LowerCWithCedille()
        {
            ...
            BooleanMap[8] = new bool[] { false, false, false, true, false, false };
            BooleanMap[9] = new bool[] { false, false, true, true, false, false };
            BooleanMap[10] = new bool[6];
        }

        public override char Character { get { return 'ç'; } }
    }
}