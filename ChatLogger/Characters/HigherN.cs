...
{
    public class HigherN : CharacterBase
    {
        public HigherN()
        {
            ...
            BooleanMap[4] = new bool[] { false, true, true, false, true, false };
            BooleanMap[5] = new bool[] { false, true, false, true, true, false };
            BooleanMap[6] = new bool[] { false, true, false, true, true, false };
        ...
        public override char Character { get { return 'N'; } }
    }
}