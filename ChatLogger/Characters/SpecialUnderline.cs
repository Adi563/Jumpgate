...
{
    public class SpecialUnderline : CharacterBase
    {
        public SpecialUnderline()
        {
            ...
            BooleanMap[8] = new bool[] { true, true, true, true, true, true };
            BooleanMap[9] = new bool[6];
            BooleanMap[10] = new bool[6];
        }

        public override char Character { get { return '_'; } }
    }
}