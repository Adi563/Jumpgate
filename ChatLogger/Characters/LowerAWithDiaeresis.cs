...
{
    public class LowerAWithDiaeresis : CharacterBase
    {
        public LowerAWithDiaeresis()
        {
            ...
            BooleanMap[4] = new bool[] { false, false, false, false, true, false };
            BooleanMap[5] = new bool[] { false, false, true, true, true, false };
        ...
        public override char Character { get { return 'ä'; } }
    }
}