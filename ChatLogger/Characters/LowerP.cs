...
{
    public class LowerP : CharacterBase
    {
        public LowerP()
        {
            ...
            BooleanMap[8] = new bool[] { false, true, false, false, false, false };
            BooleanMap[9] = new bool[] { false, true, false, false, false, false };
            BooleanMap[10] = new bool[6];
        }

        public override char Character { get { return 'p'; } }
    }
}