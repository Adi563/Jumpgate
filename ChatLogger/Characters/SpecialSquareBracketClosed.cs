...
{
    public class SpecialSquareBracketClosed : CharacterBase
    {
        public SpecialSquareBracketClosed()
        {
            ...
            BooleanMap[4] = new bool[] { false, false, true, false, true, false };
            BooleanMap[5] = new bool[] { false, false, true, false, true, false };
